...
print(f"[2/6] Clicking user menu ({MENU_X}, {MENU_Y})...")
...
# Step 3: Wait for menu & re-activate
print("[3/6] Waiting 3 seconds for menu...")
time.sleep(3)
print("    Re-activating window...")
user32.BringWindowToTop(hwnd)
time.sleep(0.2)
user32.SetForegroundWindow(hwnd)
time.sleep(0.2)
...
print(f"[4/6] Clicking check-in button ({CHECKIN_X}, {CHECKIN_Y})...")
...
# --- 新增操作：点击“领取”按钮 ---
print(f"[5/6] Clicking 领取 button ({LINGQU_X}, {LINGQU_Y})...")
time.sleep(0.5)  # 稍等签到响应
user32.SetCursorPos(LINGQU_X, LINGQU_Y)
time.sleep(0.2)
user32.mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0)
time.sleep(0.1)
user32.mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0)
print("    领取 button clicked")
# --- 新增结束 ---

time.sleep(1)
print("[6/6] Verification complete")
